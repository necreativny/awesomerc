...
local theme = {}
theme.interface_scale = 1.1
-- scale based on text height
theme.button_height_k = 1.1

theme.font          = "sans 11"

theme.bg_normal     = '#0000000'
--theme.bg_normal = '#0012121e'
--theme.bg_focus      = '#0000000'
theme.bg_focus = '#490132'
theme.bg_urgent     = "#ff0000"
theme.bg_minimize   = "#444444"
theme.bg_systray    = theme.bg_normal

theme.fg_normal     = "#FFD4A9"
theme.fg_focus      = "#FFA9A9"
theme.fg_urgent     = "#ffffff"
theme.fg_minimize   = "#C884B2"

theme.useless_gap         = 6
theme.border_width        = 1.6
theme.border_color_normal = "#000000"
theme.border_color_active = "#EC2BAD"
...
--theme.titlebar_bg = '#00fffff'
theme.titlebar_size = 12


theme.wallpaper = '~/bg_img'
theme.profile_image = '~/profile'
...
theme.launcher_width = .6
theme.launcher_height = .5
--theme.launcher_position = 'center'
...
theme.leave_event = '#fcd123'
theme.enter_event = '#fcd123' .. '10'
theme.press_event = '#fcd123' .. '15'
theme.release_event = '#fcd123' .. '10'
